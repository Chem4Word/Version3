...
namespace Chem4Word.Searcher.PubChemPlugIn
{
    public partial class Settings : Form
    {
        ...
        {
            SearcherOptions.PubChemWebServiceUri = EnsureTrailingSlash(SearcherOptions.PubChemWebServiceUri);
            SearcherOptions.PubChemRestApiUri = EnsureTrailingSlash(SearcherOptions.PubChemRestApiUri);
