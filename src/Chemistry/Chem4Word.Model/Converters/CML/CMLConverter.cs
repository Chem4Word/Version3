...
namespace Chem4Word.Model.Converters
{
    ...
    public class CMLConverter : IConverter
    {
        ...
        public string Export(Chem4Word.Model.Model model)
        {
            ...
            XElement root = new XElement(CML.CML.cml + "cml",
                new XAttribute(XNamespace.Xmlns + "conventions", CML.CML.conventions),
                new XAttribute(XNamespace.Xmlns + "cml", CML.CML.cml),
                new XAttribute(XNamespace.Xmlns + "cmlDict", CML.CML.cmlDict),
                new XAttribute(XNamespace.Xmlns + "nameDict", CML.CML.nameDict),
                new XAttribute(XNamespace.Xmlns + "c4w", CML.CML.c4w),
            ...
            {
                XElement customXmlPartGuid = new XElement(CML.CML.c4w + "customXmlPartGuid", model.CustomXmlPartGuid);
        ...
        {
            XElement result = new XElement(CML.CML.cml + "formula");
        ...
        {
            XElement result = new XElement(CML.CML.cml + "name", name.Name);
        ...
        {
            XElement result = new XElement(CML.CML.cml + "atom",
        ...
        private XElement GetStereoXElement(Bond bond)
        {
            ...
            if (bond.Stereo != BondStereo.None)
            {
                if (bond.Stereo == BondStereo.Cis || bond.Stereo == BondStereo.Trans)
                {
                    ...
                    result = new XElement(CML.CML.cml + "bondStereo",
        ...
        public XElement GetXElement(Bond bond)
        {
            ...
            result = new XElement(CML.CML.cml + "bond",
            ...
            {
                result.Add(new XAttribute(CML.CML.c4w + "placement", bond.ExplicitPlacement));
            }
            return result;
        }
        ...
        {
            XElement molElement = new XElement(CML.CML.cml + "molecule", new XAttribute("id", mol.Id));
            ...
            if (mol.Atoms.Count > 0)
            {
                ...
                XElement aaElement = new XElement(CML.CML.cml + "atomArray");
            ...
            {
                XElement baElement = new XElement(CML.CML.cml + "bondArray");
        ...
        private Molecule CreateMolecule(XElement cmlElement)
        {
            ...
            var childMolecules = CML.CML.GetMolecules(cmlElement);

            var atomElements = CML.CML.GetAtoms(cmlElement);
            var bondElements = CML.CML.GetBonds(cmlElement);
            var nameElements = CML.CML.GetNames(cmlElement);
            var formulaElements = CML.CML.GetFormulas(cmlElement);
        ...
        public Bond CreateBond(XElement cmlElement, out string message)
        {
            ...
            var dirAttr = cmlElement.Attribute(CML.CML.c4w + "placement");
            if (dirAttr != null)
            {
                BondDirection temp;
            ...
            var stereoElems = CML.CML.GetStereo(cmlElement);
            if (stereoElems.Any())
            {
